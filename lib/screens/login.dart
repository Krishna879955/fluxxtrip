...
class _LoginPageState extends State<LoginPage> {
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (!passwordRegex.hasMatch(value)) {
                              return "password must be 8 characters, 1 Uppercase letter, 1 special character";
                            }
                            return null;
                          },
                        ),
  ...
  InputDecoration _inputDecoration(String label, IconData icon) {
    return InputDecoration(
      ...
      errorMaxLines: 2, // 👈 allow the red message to break into 2 lines
    );
  }
