...
class _EndToEndNavigationPage extends State<EndToEndNavigationPage> {
      ...
      _positionSub = Geolocator.getPositionStream(
        ...
        setState(() {
          ...
          if (_lastPosition != null) {
            ...
            if (dtSeconds > 0) {
              _currentSpeedKmh = (segmentDistance / dtSeconds) * 3.6;
              final detectedMode = _inferModeFromSpeed(_currentSpeedKmh);
              _modeCounts[detectedMode] = (_modeCounts[detectedMode] ?? 0) + 1;
  ...
  String _inferModeFromSpeed(double speedKmh) {
    ...
    if (speedKmh < 15) return 'Bicycle';
    if (speedKmh < 35) return 'Car';
    if (speedKmh < 70) return 'Bus';
    return 'Train';
  }
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                          _isTracking ? const Color(0xFF22C55E) : const Color(0xFF9CA3AF),
