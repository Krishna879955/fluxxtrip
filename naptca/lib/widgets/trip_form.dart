...
class TripFormTabbed extends StatefulWidget {
  ...
  const TripFormTabbed({Key? key, required this.onSubmit}) : super(key: key);
...
class _TripFormTabbedState extends State<TripFormTabbed> {
  ...
  Position? _originPosition; // Variable to store origin coordinates
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      widget.onSubmit({
        'originPlace': _originController.text,
        'destinationPlace': _destinationController.text,
        'startTime': _startTime,
        'endTime': _endTime,
        'mode': _selectedMode,
        'purpose': _purposeController.text,
        'originPosition': _originPosition, // Pass the stored coordinates
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      // TripCapture already adds padding/card, so keep this minimal
        ...
        child: Column(
          ...
          children: <Widget>[
            TextFormField(
              ...
              decoration: _inputDecoration('Origin', Icons.location_on).copyWith(
            ...
            TextFormField(
              ...
              decoration: _inputDecoration('Destination', Icons.flag_rounded),
              style: const TextStyle(color: Color(0xFF111827)),
            ...
            TextFormField(
              ...
              decoration:
              _inputDecoration('Purpose of Trip', Icons.help_outline_rounded),
              style: const TextStyle(color: Color(0xFF111827)),
              validator: (value) => value == null || value.isEmpty
